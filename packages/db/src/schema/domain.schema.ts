...
export const opportunityAuctions = pgTable(
  ...
  (table) => [
    ...
    index('idx_auction_street_address').on(table.streetAddress),
    index('idx_auction_city').on(table.city),
...
export const opportunitySuccessions = pgTable(
  ...
  (table) => [
    ...
    index('idx_succession_street_address').on(table.streetAddress),
    index('idx_succession_city').on(table.city),
...
export const opportunityLiquidations = pgTable(
  ...
  (table) => [
    ...
    index('idx_liquidation_street_address').on(table.streetAddress),
    index('idx_liquidation_city').on(table.city),
...
export const energyDiagnostics = pgTable(
  ...
  (table) => [
    ...
    index('idx_energy_sieve_street_address').on(table.streetAddress),
    index('idx_energy_sieve_city').on(table.city),
...
export const opportunityListings = pgTable(
  ...
  (table) => [
    ...
    index('idx_listing_street_address').on(table.streetAddress),
