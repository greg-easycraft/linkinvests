...
import { Liquidation } from "../types/liquidation.types.js";
...
export const LIQUIDATION_1: Liquidation = {
    ...
    latitude: 48.8606,
    longitude: 2.3376,
    opportunityDate: new Date('2024-01-25').toISOString().split('T')[0] as string,
...
export const LIQUIDATION_2: Liquidation = {
    ...
    latitude: 48.8738,
    longitude: 2.2874,
    opportunityDate: new Date('2024-02-12').toISOString().split('T')[0] as string,
...
export const LIQUIDATION_3: Liquidation = {
    ...
    latitude: 45.7797,
    longitude: 4.9539,
    opportunityDate: new Date('2024-03-08').toISOString().split('T')[0] as string,
...
export const LIQUIDATION_4: Liquidation = {
    ...
    latitude: 43.5263,
    longitude: 5.4454,
    opportunityDate: new Date('2024-04-18').toISOString().split('T')[0] as string,
...
export const LIQUIDATION_5: Liquidation = {
    ...
    latitude: 43.6108,
    longitude: 3.8767,
    opportunityDate: new Date('2024-05-30').toISOString().split('T')[0] as string,
