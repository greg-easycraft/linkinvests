...
export const SUCCESSION_1: Succession = {
  ...
  latitude: 44.8378,
  longitude: -0.5792,
  opportunityDate: new Date('2024-01-30').toISOString().split('T')[0],
...
export const SUCCESSION_2: Succession = {
  ...
  latitude: 48.8534,
  longitude: 2.3488,
  opportunityDate: new Date('2024-02-14').toISOString().split('T')[0],
...
export const SUCCESSION_3: Succession = {
  ...
  latitude: 48.5734,
  longitude: 7.7521,
  opportunityDate: new Date('2024-03-22').toISOString().split('T')[0],
...
export const SUCCESSION_4: Succession = {
  ...
  latitude: 45.7578,
  longitude: 4.832,
  opportunityDate: new Date('2024-04-16').toISOString().split('T')[0],
...
export const SUCCESSION_5: Succession = {
  ...
  latitude: 43.6947,
  longitude: 7.262,
  opportunityDate: new Date('2024-05-28').toISOString().split('T')[0],
