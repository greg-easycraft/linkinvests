            ...
            <div className="grid grid-cols-3 gap-x-4 gap-y-2 text-sm">
              ...
              {type === OpportunityType.AUCTION && isAuction(opportunity) && (
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <div className="text-xs opacity-70 font-heading">Prix de réserve</div>
                    <div className="font-semibold text-orange-600">
                      {opportunity.reservePrice ?formatPrice(opportunity.reservePrice) : 'NC'}
                    </div>
                  </div>
                </div>
              )}
              ...
              {type === OpportunityType.AUCTION && isAuction(opportunity) && opportunity.currentPrice && (
                <div className="flex items-start gap-2">
                  <Euro className="h-4 w-4 mt-0.5 flex-shrink-0 text-[var(--primary)] opacity-70" />
                  <div>
