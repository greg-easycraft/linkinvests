 ...
 * The department names in the `label` field use spaces instead of hyphens, except for the hyphen separating the code and the name.
...
export const FRENCH_DEPARTMENTS: DepartmentOption[] = [
  ...
  { id: "04", name: "Alpes-de-Haute-Provence", label: "04 - Alpes de Haute Provence" },
